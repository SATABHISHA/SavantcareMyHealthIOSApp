//
//  NavigationDrawerHelpdeskViewController.swift
//  MyHealth
//
...
class NavigationDrawerHelpdeskViewController: UIViewController {
    ...
    func onMenuClick(){
        let tap = UITapGestureRecognizer(target: self, action: #selector(NavigationDrawerHelpdeskViewController.tapFunction_View))
