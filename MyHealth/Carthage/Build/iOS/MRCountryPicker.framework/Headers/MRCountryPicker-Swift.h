...
SWIFT_MODULE_NAMESPACE_PUSH("MRCountryPicker")
@protocol MRCountryPickerDelegate;
@class NSCoder;
@class UIView;

SWIFT_CLASS("_TtC15MRCountryPicker15MRCountryPicker")
@interface MRCountryPicker : UIPickerView <UIPickerViewDataSource, UIPickerViewDelegate>
@property (nonatomic, copy) NSLocale * _Nullable selectedLocale;
...
- (void)setCountryByName:(NSString * _Nonnull)name;
...
SWIFT_PROTOCOL("_TtP15MRCountryPicker23MRCountryPickerDelegate_")
@protocol MRCountryPickerDelegate
